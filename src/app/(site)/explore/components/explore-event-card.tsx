    ...
    <div className="w-full rounded-[6px] bg-white border border-gray-5 overflow-hidden">
      <div className="grid grid-cols-2">
        <div className="relative">
          <div className="w-full sm:min-h-[207px] min-h-[180px] h-full bg-gray-4 flex justify-center items-center">
        ...
        <div className="sm:px-[24px] px-[18px] sm:pb-[22px] pb-[16px] flex flex-col justify-center">
          <p className="text-primary text-[14px] mb-3">From $ 20</p>
          <h4 className="text-[16px] font-bold text-black-1 mb-3">
            Urban Marathon
          </h4>
          <div className="sm:flex hidden gap-2 items-center mb-[8px]">
            <Calendar size={16} className="text-primary" />
            <p className="text-primary text-[14px] font-bold">
              Monday, June 06 | 06:00 AM
            </p>
          </div>
          <div className="flex sm:hidden gap-2 items-center mb-[8px]">
            <Calendar size={16} className="text-primary" />
            <p className="text-primary text-[14px] font-bold">
              June 06 | 06:00 AM
            </p>
